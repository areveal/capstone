								  		...
								  		<table class="table table-hover">
								    			...
								    			@foreach($skills_owned as $skill_owned)
								    				<tr>
								    						...
								    						<div class="btn-group">
								    						<button type="submit" class="btn btn-default btn-sm">{{{ $skill_owned->skill  . '  '}}}</button>
								    						<button type="submit" class="btn btn-default btn-sm" data-toggle="dropdown">
							...
							<div style="margin-left: 40px" class="col-md-3">
							  	...
							  	<div>
							  		...
							  		<table>
							  				...
							  				<tr><button style=" padding-left: 10px; text-align: left; height: 50px;" class=" btn btn-default btn-sm btn-block"><strong><h4><a href="">2. Skills</a></h4></button></strong></tr>
