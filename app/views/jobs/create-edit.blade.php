						...
						<div class="col-app">
							...
							<div class="login" style="padding-left:180px">
								...
								<div class="widget-head">
									<br>
                    				<h4 class="heading glyphicon glyphicon-briefcase"><i> </i>Experience</h4>
						  		...
						  		<div style="margin-left: 40px" class="col-md-3">
					  				<div>
								  		...
								  		<table>
								    			...
								    			<tr><a style="padding-left: 10px; text-align: left; height: 50px;" class=" btn btn-default btn-sm btn-block" href="{{ action('JobsController@edit', Auth::user()->slug)}}"><strong><h4 style="color: #3498db">4. Experience</h4></a></strong></tr>
